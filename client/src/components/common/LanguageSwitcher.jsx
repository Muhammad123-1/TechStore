...
export default function LanguageSwitcher() {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute left-0 right-auto md:right-0 md:left-auto mt-2 w-48 bg-dark-card border border-gray-800 rounded-lg shadow-glow z-50 animate-fade-in overflow-hidden">
                    {languages.map((lang) => (
                        <button
                            key={lang.code}
