            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    {locations.length > 0 ? (
                        locations.map((loc) => (
                            <div key={loc._id} className="card p-6">
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <div>
                                        <h3 className="font-bold mb-2">{loc.name}</h3>
                                        <p className="text-text-secondary mb-1">{loc.address}</p>
                                        <p className="text-text-secondary text-sm">
                                            <span className="text-primary">{loc.workingHours}</span>
                                        </p>
                                        {loc.phone && <p className="text-sm mt-1">{loc.phone}</p>}
                                    </div>
                                </div>
                                {loc.mapUrl && (
                        ...
                        /* Fallback Static Location if none in DB */
                        <>
                            <div className="card p-6">
                                <div className="flex items-start gap-4">
                                    <MapPin className="text-primary mt-1" size={24} />
